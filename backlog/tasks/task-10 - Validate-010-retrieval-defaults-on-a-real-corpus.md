...
<!-- SECTION:NOTES:BEGIN -->
DONE for floor + fusion validation. Rerank (SC-006) spun out to TASK-11 (needs a configured cross-encoder role). Shipped in 0.2.1 on this branch: floor default 0.3→0.2 (real-corpus knee), RRF confirmed as default, +2 engine bug fixes (ddb detect on >64KiB-preamble pages; worker complete()). Eval report + wiki re-pinned.
<!-- SECTION:NOTES:END -->
