...
- [x] T042 Author `specs/010-retrieval-eval-harness/evidence.md`: SC verdict table with live evidence, FR spot-verification, visibility-avenue table (plan.md's, verified live), wiki-impact decision, link to the eval report — the converge-gate record
